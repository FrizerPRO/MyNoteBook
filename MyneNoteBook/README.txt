Данная программа имеет все функции, предусмотренные основным функционалом ТЗ. 
Всевозможные способы взаимодецствия с программой:
Клик ПКМ по вкладке, полю с текстом;
Использование верхней панели Меню;
Из дополнительного функционала присутствуют пункты* 13,14,15,16,17
Пункты* 15,16,17 работают только с файлом *.cs 
